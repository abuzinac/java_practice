...
//    NOTE: The areEqualByThreeDecimalPlaces method  needs to be defined
//    as public
//    static like we have been doing so far in the course. NOTE: Do not add a  main method to
//    solution code
    ...
    public static boolean areEqualByThreeDecimalPlaces(double $a, double $b) {
        ...
        // multiple decimal number with 1000 because we compare three decimal place
        $a *= 1000;
        $b *= 1000;

        // convert double into integers
        int $a1 = (int) $a;
        int $b1 = (int) $b;
